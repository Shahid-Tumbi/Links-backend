...
export const ADMIN_MESSAGES = {
  ...
  LOGIN: {
    ...
    INVALID: defineMessage(
      'Oops! This doesn’t seem like a correct password/email',
...
export const COLLECTION_NAME = 'admin';
export const LinksConstant = {
  // S3BucketUrl : 'https://profileimageuploadbyhelpie.s3.amazonaws.com/HelpiePhotographer/'
  S3BucketUrl: {
    photographer:
      'https://web.helpiephoto.com/v1/admin/file/HelpiePhotographer/',
    user: 'https://web.helpiephoto.com/v1/admin/file/HelpieUser/',
  },
};
