...
export const UserDetailModel = model<IUser.Doc>(
  COLLECTION_NAME.userDetail,
  userDetailSchema
);
...
export const FollowModel = model<IUser.Doc>(
...
export const FollowRequestModel = model<IUser.Doc>(
  COLLECTION_NAME.followRequest,
  followRequestSchema
);
